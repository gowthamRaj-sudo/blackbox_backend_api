...
const uploadLegderFileModal = async (ledgerData) => {
  const sql = `INSERT INTO ledgerDataTable(Portfolio_Name,Leg_ID,Exchange,Exchange_Symbol,Product,Order_Type,Order_ID,Time,Txn,Qty,Filled_Qty,Exchg_Time,Avg_Price,Status,Limit_Price,Order_Failed,User_ID,User_Alias,Remarks,Tag)
     VALUES ?`;
